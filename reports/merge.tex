...
\begin{figure}[h]
  \begin{subfigure}{0.3\textwidth}
    \includegraphics[width=\textwidth]{../out/merge-average.png}
    \caption{Average case}
    \label{fig:merge-avg}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[width=\textwidth]{../out/merge-best.png}
    \caption{Best case}
    \label{fig:merge-best}
  \end{subfigure}
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[width=\textwidth]{../out/merge-worst.png}
    \caption{Worst case}
