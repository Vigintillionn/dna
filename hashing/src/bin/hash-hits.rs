...
fn main() {
    Algorithm::new("Hashing Hits", |arr| calculate(arr, 0.5))
      .with_case(
        Case::new("Hits")
          ...
          .range((0, 5000))
          .plots(vec![
            Plot::new(|_| expected_hit(0.5), RED, "Expected")
          ])
      )
      .run()
      .plot("hashing-hits-0.5")
      .unwrap();

  // Combinator::new("Hashing")
  //   .add_algorithms(vec![
  //     Algorithm::new("Hashing - Alpha = 0.5", |arr| calculate(arr, 0.5))
  //       .with_case(
  //         Case::new("Misses")
  //           .with_generator(|size| (0..size as i32).collect())
  //           .iterations(50)
  ...
  //           .range((0, 5000))
  //           .plots(vec![
  //             Plot::new(|_| expected_miss(0.5), RED, "Expected")
  //           ])
  //       ),
  //     Algorithm::new("Hashing - Alpha = 0.6", |arr| calculate(arr, 0.6))
  //       .with_case(
  //         Case::new("Misses")
  //           .with_generator(|size| (0..size as i32).collect())
  //           .iterations(50)
  ...
  //           .range((0, 5000))
  //           .plots(vec![
  //             Plot::new(|_| expected_miss(0.6), RED, "Expected")
  //           ])
  //       ),
  //     Algorithm::new("Hashing - Alpha = 0.75", |arr| calculate(arr, 0.75))
  //       .with_case(
  //         Case::new("Misses")
  //           .with_generator(|size| (0..size as i32).collect())
  //           .iterations(50)
  ...
  //           .range((0, 5000))
  //           .plots(vec![
  //             Plot::new(|_| expected_miss(0.75), RED, "Expected")
  //           ])
  //       )
  //   ])
  //   .run()
  //   .plot_seperate(vec!["hashing-misses-0.5", "hashing-misses-0.6", "hashing-misses-0.75"])
  //   .unwrap();
...
fn calculate(arr: &mut [i32], alpha: f64) -> f64 {
  ...
  let (table, inserted) = create_table_with_load(alpha, arr.len());
